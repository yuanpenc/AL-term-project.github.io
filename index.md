...
We also publish the data of sound module sensor on the OpenCHirp, as shown by the picture below.

<p align="center">
  <img src="/img/pr11/openchirp soundmodule.png" width="700">
</p>
<p align="center">
  Figure 10. Time series for Output of sound module sensor  
</p>


## Discussion
1. The sound module sensor is binary, which can only generate binary value.If we can change a  sound sensor that can get the amplitude and frequency of the sound. We make more fun, like turn the light on and off according the frequency. 
